...
export class SFX{
    ...
    hit( vol = this.defaultVol ){
        zzfxV = vol;
        zzfx(...[1.9,,387,.03,.07,.29,4,2.3,8,,,,,1.3,,.1,.07,.67,.03]);
        zzfxV = this.defaultVol;
    }

    shoot( vol = this.defaultVol ){
        zzfxV = vol;
        zzfx(...[1.5,,360,.01,.12,.06,1,3.9,-16,16,,,,,,.2,.01,.98,.19]);
        zzfxV = this.defaultVol;
    }

    gameOver( vol = this.defaultVol ){
        zzfxV = vol;
        zzfx(...[,,925,.04,.3,.6,1,.3,,6.27,-184,.09,.17])
        zzfxV = this.defaultVol;
    }
   
    heart( vol = this.defaultVol ){
        zzfxV = vol;
        zzfx(...[,,537,.02,.02,.22,1,1.59,-6.98,4.97]); // Heart
        zzfxV = this.defaultVol;
    }
    
    piano( vol = this.defaultVol ){
        zzfxV = vol;
        zzfx(...[1.5,.8,270,,.1,,1,1.5,,,,,,,,.1,.01]); // Piano
        zzfxV = this.defaultVol;
    }

    drum( vol = this.defaultVol ){
        zzfxV = vol;
